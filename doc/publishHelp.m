...
fun_files = {...
    [proj_dir filesep 'sssMOR' filesep 'software' filesep 'MOR' filesep 'ltiMor' filesep 'classic'] ,...
    [proj_dir filesep 'sssMOR' filesep 'software' filesep 'MOR' filesep 'ltiMor' filesep 'stateOfTheArt'] ,...
	[proj_dir filesep 'sssMOR' filesep 'software' filesep 'extras'] ,...
    [proj_dir filesep 'sssMOR' filesep 'software' filesep 'sss' filesep 'src' filesep '@sss'] ,...
	[proj_dir filesep 'sssMOR' filesep 'software' filesep 'sss' filesep 'src' filesep 'extras'] ,...
    [proj_dir filesep 'sssMOR' filesep 'demos'] ,...
    };
...
footer_ = sprintf('%s\n', ...
    ...
    '% <html>', ...
    '%   <hr>', ...
    [ '%   <p class="copy">&copy; ' year_ ' RT Technische Universit&auml;t M&uuml;nchen'], ...
