function updateIndexFiles( helpSource_, productName_ )
...
now_ = datestr(now, 'dd mmm yyyy HH:MM');
comment_ = sprintf( ...
  [ '\n%s Toolbox\n' ...
  'Copyright (c) %s' ...
  ' Institute of Computational and Engineering Mechanics,\n' ...
  '  University of Stuttgart\n' ...
  'See LICENSE.txt for license information.\n' ...
  'web: http://www.itm.uni-stuttgart.de\n' ...
  '\n(This file has been modified automatically on %s)\n' ], ...
  upper(productName_), year_, now_ );
