...
% ------------------------------------------------------------------
% USAGE:  This is an auxiliary function for all demos. It prints out
% a unified set of lines and should be called at the end of each demo.
%
% See also MORLAB_GETTINGSTARTED, SSS.
%
% ------------------------------------------------------------------
...
fprintf('the capabilities of the MORLab toolbox by yourself! (Check out all \n');
