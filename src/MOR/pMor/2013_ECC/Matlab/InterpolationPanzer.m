...
function [sys_int] = InterpolationPanzer(p_ref, p_int, V, W, sys_ref)
...
%     Q = U*Z';
%     
%     [UP, SP, ZP] = svd(W{i}'*W{1});
%     P = UP*ZP';

%     [U, S, Z] = svd(V{i}'*R);
%     Q = U*Z';
%     
%     [UP, SP, ZP] = svd(W{i}'*W{3});
%     P = UP*ZP';
...
[sys_int] = InterpolationManifold(p_ref, p_int, sys_ref_Kon, 3, 'spline');
